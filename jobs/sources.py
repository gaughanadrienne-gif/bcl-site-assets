...
JOB_SOURCES = [
    ...
    _s("Central Fire District", "direct_page_reviewed", "calopps", "calopps",
       "https://www.calopps.org/centralfiresc", "area", 6, True, True,
       "task URL 404s; fixed to the real agency slug"),
    ...
    _s("Nob Hill Foods / Raley's", "direct_page_reviewed", "oracle", "oracle",
       "https://www.raleys.com/about/careers/job-openings", "area", 9, True, True, "Oracle Recruiting; keyword filter",
    ...
    _s("Safeway (Albertsons)", "direct_page_reviewed", "oracle", "oracle",
       ...
       {"rest_url": "https://eofd.fa.us6.oraclecloud.com/hcmRestApi/resources/latest/recruitingCEJobRequisitions?keyword=Santa+Cruz",

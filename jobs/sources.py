...
JOB_SOURCES = [
    ...
    _s("City of Santa Cruz", "direct_page_reviewed", "neogov", "neogov",
       ...
       config={"location_cities": ["Santa Cruz"]}),
    ...
    _s("Cabrillo College", "direct_page_reviewed", "neogov", "neogov",
       ...
       config={"location_cities": ["Aptos", "Watsonville"]}),
    ...
    _s("Remotive (remote)", "api_authorized", "remote_json", "remote_json",
       "https://remotive.com/api/remote-jobs", "remote", 15, False, True,
       "Disabled 2026-09-13: local-employer jobs only; generic remote inventory is out of scope.", {"eligibility_field": "candidate_required_location"}),
    _s("We Work Remotely (remote)", "feed_authorized", "rss", "rss",
       "https://weworkremotely.com/remote-jobs.rss", "remote", 15, False, True,
       "Disabled 2026-09-13: local-employer jobs only; generic remote inventory is out of scope.",
       {"style": "wwr"}),
